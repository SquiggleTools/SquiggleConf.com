import aakanshaDoshi from "~/assets/avatars/aakansha-doshi.webp";
import aaronHarper from "~/assets/avatars/aaron-harper.webp";
import chrisGriffing from "~/assets/avatars/chris-griffing.webp";
import corinaMurg from "~/assets/avatars/corina-murg.webp";
import danFarrelly from "~/assets/avatars/dan-farrelly.webp";
import danVanderkam from "~/assets/avatars/dan-vanderkam.webp";
import donIsaac from "~/assets/avatars/don-isaac.webp";
import fatimaSarahKhalid from "~/assets/avatars/fatima-sarah-khalid.webp";
import jessLin from "~/assets/avatars/jess-lin.webp";
import katerinaSkroumpelou from "~/assets/avatars/katerina-skroumpelou.webp";
import laurynasKeturakis from "~/assets/avatars/laurynas-keturakis.webp";
import lorisCro from "~/assets/avatars/loris-cro.webp";
import maxKless from "~/assets/avatars/max-kless.webp";
import nickNisi from "~/assets/avatars/nick-nisi.webp";
import rachelNabors from "~/assets/avatars/rachel-nabors.webp";
import rickViscomi from "~/assets/avatars/rick-viscomi.webp";
import rizelScarlett from "~/assets/avatars/rizel-scarlett.webp";
...
export const peopleBySlug: Record<string, PersonInfo> = {
	...
	"chris-griffing": {
		...
		links: {
			...
			x: "https://x.com/cmgriffing",
			youtube: "https://youtube.com/@cmgriffing",
		},
		name: "Chris Griffing",
		qualification: "WASM Fanatic at [GitKraken](https://www.gitkraken.com)",
		slug: "chris-griffing",
	},
	"corina-murg": {
		biography:
		...
		links: {
			...
			x: "https://x.com/CorinaMurg",
			youtube: null,
		},
		name: "Corina Murg",
		qualification:
			"Accessibility Engineer; Founder, [Web for Everyone](https://webforeveryone.us)",
		slug: "corina-murg",
	},
	"dan-farrelly": {
		biography:
			"I'm Dan. I am a founder at [Inngest](https://www.inngest.com) and spent previous several years as CTO at [Buffer](https://buffer.com). Back when I had more time I built [Timezone.io](https://timezone.io) \\(service, [open-source](https://github.com/timezoneio/timezoneio)\\) and [MailDev](https://maildev.github.io/maildev) \\(dev tool, [open-source](https://github.com/maildev/maildev)\\).  In 2020 I bought a 96 year old house and started [a restoration and renovation project](https://www.instagram.com/michigancraftsman) on the weekends. Hit me up if you want to chat home renovations.",
		image: danFarrelly,
		links: {
			bluesky: null,
	...
	"dan-vanderkam": {
		...
		links: {
			...
			twitch: null,
			website: null,
			x: "https://x.com/danvdk",
			youtube: null,
		},
		name: "Dan Vanderkam",
		qualification:
			"TypeScript Compiler Contributor; [_Effective TypeScript_](https://effectivetypescript.com) Author",
		slug: "dan-vanderkam",
	},
	"don-isaac": {
		biography:
		...
		links: {
			...
			twitch: null,
			website: null,
			x: "https://x.com/Don_dev_",
			youtube: null,
		},
		name: "Don Isaac",
		qualification: "[JavaScript Oxidation Compiler](https://oxc.rs) Maintainer",
		slug: "don-isaac",
	},
	"fatima-sarah-khalid": {
		biography:
	...
	"katerina-skroumpelou": {
		...
		links: {
			...
			x: "https://x.com/psybercity",
			youtube: null,
		},
		name: "Katerina Skroumpelou",
		qualification:
			"Senior Engineer, [Nx](https://nx.dev); Google Developer Expert for Angular",
	...
	"laurynas-keturakis": {
		...
		links: {
			...
			x: "https://x.com/_laurynas",
			youtube: null,
		},
		name: "Laurynas Keturakis",
		qualification:
			"[fpx](https://github.com/fiberplane/fpx) Maintainer; Developer, [Fiberplane](https://fiberplane.com)",
	...
	"loris-cro": {
		...
		links: {
			...
			x: "https://x.com/croloris",
			youtube: "https://www.youtube.com/@ZigSHOWTIME",
		},
		name: "Loris Cro",
		qualification:
			"Zig Livecoder; VP Community, [Zig Software Foundation](https://ziglang.org/zsf)",
		slug: "loris-cro",
	},
	"max-kless": {
		biography:
			"Max is a software engineer at [Nx](https://nx.dev) and works on the core team. He spends a lot of his time building [Nx](https://nx.dev/getting-started/intro) & [Nx Console](https://nx.dev/recipes/nx-console) - a VSCode and JetBrains extension for Nx workspaces. When not digging through code, he spends his time travelling, reading sci-fi and listening to music.",
		image: maxKless,
		links: {
			bluesky: null,
			...
			twitch: null,
			website: null,
			x: "https://x.com/MaxKless",
			youtube: null,
		},
		name: "Max Kless",
		qualification:
			"[Nx Console](https://github.com/nrwl/nx-console) VSCode Extension Maintainer; Senior Engineer, [Nx](https://nx.dev)",
		slug: "max-kless",
	},
	"nick-nisi": {
		biography:
	...
	"rizel-scarlett": {
		...
		name: "Rizèl Scarlett",
		qualification:
			"Staff Developer Advocate, [TBD](https://developer.tbd.website)",
		slug: "rizel-scarlett",
	},
	"robby-russell": {
		biography:
		...
		name: "Robby Russell",
		qualification:
			"[Oh My Zsh](https://ohmyz.sh) Creator; CEO, [Planet Argon](https://www.planetargon.com); host of [Maintainable](https://maintainable.fm)",
		slug: "robby-russell",
	},
	"titian-cernicova-dragomir": {
		...
		links: {
			...
			twitch: null,
			website: null,
			x: "https://x.com/TitianCernicova",
			youtube: null,
		},
		name: "Titian Cernicova-Dragomir",
		qualification:
			"TypeScript Compiler Contributor; Software Engineer, [Bloomberg](https://www.bloomberg.com)",
	...
	"yagiz-nizipli": {
		...
		name: "Yagiz Nizipli",
		qualification:
			"[Node.JS TSC](https://github.com/nodejs/TSC) Member & Frequent [Contributor](https://github.com/nodejs/node/commits?author=anonrig); Principal Systems Engineer, [Cloudflare](https://www.cloudflare.com)",
		slug: "yagiz-nizipli",
	},
};

export const talksBySlug: Record<string, SessionInfo> = {
	"talk-aakansha-doshi": {
		description:
